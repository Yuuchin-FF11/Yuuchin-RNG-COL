...
const weaponWSData = {
    HandToHand: [
        ...
        { name: "四神円舞", attrs: ["核熱", "振動"], type: "格闘 (メリポ)" },
    ...
    GreatSword: [
        { name: "トアクリーバー", attrs: ["分解", "切断"], type: "両手剣 (エンピ)" },
    ...
    Polearm: [
        ...
        { name: "インパルスドライヴ", attrs: ["重力", "硬化"], type: "両手槍 (習得)" },
        { name: "ダブルスラスト", attrs: ["貫通"], type: "両手槍 (初期)" }
    ],
    Katana: [
        { name: "瞬", attrs: ["核熱", "衝撃"], type: "片手刀 (メリポ)" },
    ...
    Club: [
        ...
        { name: "ブラックヘイロー", attrs: ["分解", "収縮"], type: "片手棍 (習得)" },
        { name: "フラッシュノヴァ", attrs: ["硬化", "振動"], type: "片手棍 (習得)" },
        { name: "ジャッジメント", attrs: ["収縮"], type: "片手棍 (習得)" }
    ],
    Staff: [
        { name: "シャッターソウル", attrs: ["重力", "硬化"], type: "両手棍 (メリポ)" },
        { name: "カタクリズム", attrs: ["収縮", "衝撃"], type: "両手棍 (習得)" },
        { name: "レトリビューション", attrs: ["重力", "振動"], type: "両手棍 (習得)" },
        { name: "スピリットテーカー", attrs: ["収縮", "振動"], type: "両手棍 (習得)" },
        { name: "シェルクラッシャー", attrs: ["衝撃"], type: "両手棍 (習得)" }
    ],
    Bow: [
        { name: "南無八幡", attrs: ["光", "湾曲"], type: "弓術 (与一の弓)" },
        { name: "ジシュヌの輝き", attrs: ["光", "核熱"], type: "弓術 (ガーンデーヴァ)" },
        { name: "エイペクスアロー", attrs: ["分解", "貫通"], type: "弓術 (習得)" },
        { name: "射影", attrs: ["切断", "振動"], type: "弓術 (習得)" }
    ],
    Marksmanship: [
        { name: "ラストスタンド", attrs: ["核熱", "振動"], type: "射撃 (メリポ)" },
        { name: "カラナック", attrs: ["光", "分解"], type: "射撃 (アナイアレイター)" },
        { name: "ワイルドファイア", attrs: ["闇", "重力"], type: "射撃 (アルマゲドン)" },
        { name: "デトネーター", attrs: ["核熱", "貫通"], type: "射撃 (習得)" }
    ]
};
