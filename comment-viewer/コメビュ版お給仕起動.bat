...
start msedge.exe --disable-web-security --disable-site-isolation-trials --autoplay-policy=no-user-gesture-required --user-data-dir="%temp%\edge_translation_app" --use-fake-ui-for-media-stream --app="http://localhost:8080/comment-viewer/admin.html"
