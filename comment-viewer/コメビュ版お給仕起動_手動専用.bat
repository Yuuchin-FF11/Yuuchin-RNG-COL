...
start msedge.exe --disable-web-security --disable-site-isolation-trials --user-data-dir="%temp%\edge_translation_app" --use-fake-ui-for-media-stream --app="http://localhost:8080/comment-viewer/管理画面_手動専用.html"
